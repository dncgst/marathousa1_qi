...
The analysis of archaeological site formation processes, intensively studied since the early 1970s \citep[][among others]{Isaac1967,Schiffer1972,Schiffer1983,Schiffer1987,Shackley1978,Wood1978,Schick1984,Schick1986,Schick1987,Petraglia1987,Petraglia1994} %add Binford1977,1980,1981
...
% The spatio-temporal dimension is indeed an ineluctable property of every geological and taphonomic process. However, while the spatio-temporal dimensions of anthropogenic or geogenic processes have been always explicitily regarded in formation theory and taphonomy \citep{}, the parallel application of spatio-temporal quantitative methods only relatively recently developed.
% The spatial properties of archaeological data represent a crucial point where formation theory and taphonomy converge \citep{Bailey2007}.

%% Overview of spatial methods
The study of the clast fabric (the orientation of elongated sedimentary particles, including bones and artefacts), first addressed by \cite{Voorhies1966,Isaac1967,Bar-Yosef1972,Schick1986} %as being ... of transport...
...
An erosional contact separates the two main find-bearing units in both areas, namely UA3c/4 and UB4c/5a (Fig.~\ref{fig:3}). In Area A, the elephant remains lie at the contact of UA3c/4 and are covered by UA3c; while in Area B, most of the remains were collected from unit UB4c. %add sedimentological descriptions (see Karkanas et al., this issue)
...
% define here the depositional models that you're about to test! Autochthonous origin of the assemblages (sensu Dominguez-Rodrigo2012) vs allochthonous origin (sensu Dominguez-Rodrigo2012) and a subsequent redeposition -where? - triggered by a massive process, e.g., debris or hyperconcentrated flows.
...
% The a-axis in sedimentology is the longest axis of the triaxial ellipsoid which describe the particle. Althought other axes have been used in for the registration of orientation data, we used compass and inclinomer to record dip and strike of the SLA of elongated remians, mostly bones, because ...
...
\begin{table}[]
  \caption{Global tests for circular uniformity}
  \label{tab:3}
  \resizebox{1\textwidth}{!}{
    \begin{tabular}{lllllllllll}
      ...
      \cline{3-10}
      Sample                    & mean dir.   & $\bar{R}$       & $p-value$        & test     & critical value  & test     & critical value  & test     & critical value & level \\
      \hline
      UA3c                      & 77.17°      & 0.268           & 0.029            & 2.4698   & 2.001           & 0.2967   & 0.267           & 271.8367 & 160.53         & 0.01  \\
      UA4                       & 35.79°      & 0.386           & 0.003            & 2.5656   & 2.001           & 0.3437   & 0.267           & 246.3158 & 163.73         & 0.01  \\
      \emph{E. (P.) antiquus}   & 54.64°      & 0.489           & 2.775e-07        & 3.4811   & 2.001           & 0.906    & 0.267           & 291.4286 & 155.49         & 0.01  \\
      UB4c (clock)              & 83.96°      & 0.167           & 0.091            & 2.327    & 2.001           & 0.2466   & 0.267           & 309.7674 & 155.49         & 0.01  \\
      UB4c (compass)            & 128.14°     & 0.225           & 0.037            & 1.6917   & 2.001           & 0.1862   & 0.267           & 153.3846 & 155.49         & 0.01  \\
      \hline
    \end{tabular}
  }
\end{table}
