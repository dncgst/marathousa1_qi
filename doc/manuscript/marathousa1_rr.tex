...
\begin{figure*}[]
  ...
  \caption{Photograph (2017) of the left femur of the \emph{P. antiquus} skeleton, lying at the UA3c/4 contact and covered by unit UA3c (a). West profile (2014) of the excavation Area B (square 932/603), exposing the UB4c/5a (black solid line) and the UB5c/6 erosional contacts (b).}
  \label{fig:4}
\end{figure*}
