...
pdf("./doc/artwork/Fig4.pdf", width=25, height=5)
...
postscript("./doc/artwork/Fig5.eps", width=10, height=10)

pdf("./doc/artwork/Fig5_r.pdf", width=20, height=10)

par(mfcol=c(1,1), ps=12, cex=1, cex.main=1, cex.axis=1, cex.lab=1)

## eigenvalues ratio graph
plot(log(UA3c.s2_s3),log(UA3c.s1_s2),pch=15,xlim=c(0,3),ylim=c(0,3),xlab="ln S2/S3",ylab="ln S1/S2", main="Woodcock diagram")
...
par(ps=12, cex=1, cex.main=1, cex.axis=1, cex.lab=1) # cex.main=2 for pub; 1 for poster 
